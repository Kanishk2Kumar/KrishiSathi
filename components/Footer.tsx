    ...
    <footer suppressHydrationWarning={true} className="bg-black pb-12 px-6">
      <div className="max-w-7xl mx-auto flex flex-row justify-between items-start gap-12 lg:gap-20">
        ...
        <div className="flex flex-col items-start mt-6 lg:w-1/3 w-full">
          <a href="/">
            <Image src="/images/Logo1.png" width={120} height={120} alt="Footer Logo" className="rounded-r-full rounded-l-lg"/>
          </a>
          <p className="mt-6 text-sm leading-6 text-gray-300 sm:max-w-sm">
          Krishi Sathi is a smart farming initiative empowering farmers through innovation, technology, and personalized support. By combining AI, IoT, and real-time insights, we help farmers make better decisions, improve crop health, and increase profits.
          </p>
        ...
        {/* Links section */}
        <div className="flex flex-wrap justify-between lg:w-1/3 w-full mr-40 mt-10">
